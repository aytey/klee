...
// https://discourse.llvm.org/t/rfc-remove-most-constant-expressions/63179
    ...
    case Instruction::FRem:
      // Needs an FPRoundToIntegral expression to express; see the FRem case in
      // Executor::executeInstruction().
      llvm_unreachable("FRem ConstantExpr is not supported");
    ...
    case Instruction::FCmp: {
      ...
      llvm_unreachable("FCmp ConstantExpr did not fold to a constant");
    }
    }
