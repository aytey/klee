...
// RUN: %klee --single-repr-for-nan=1 -search=dfs -use-construct-hash-z3=1 -debug-assignment-validating-solver -debug-z3-validate-models --output-dir=%t.klee-out --exit-on-error %t1.bc
#include "klee/klee.h"
#include <assert.h>
#include <stdio.h>
#include <string.h>
